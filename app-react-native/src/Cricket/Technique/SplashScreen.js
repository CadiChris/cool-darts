...
class SplashScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => { this.setState({splashScreenActif:false})}, dureeDuSplash)
  }
  ...
  render() {
    ...
    const splashScreen = (
      <FadeInView dureeDuFade={dureeDuSplash / 1.5} style={[Styles.container, {backgroundColor: 'rgb(58,127,144)'}]}>
        <View style={[{height:'75%', alignItems:'center', justifyContent:'center'}]}>
          <Image source={require('./../../../assets/splashscreen.png')} style={{width:'66%'}} resizeMode='contain'/>
